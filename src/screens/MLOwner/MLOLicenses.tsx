...
const MLOLicenses = () => {
  ...
  const goHome = () => {
    navigation.navigate('MLOwner');  // Navigate to 'Licenses' screen
  };
  const handleHistory = () => {
  ...
  const renderLicenseTile = ({ item }: { item: License }) => (
    ...
    <View style={styles.tile}>
      ...
      <View style={styles.tileContent}>
        ...
        <TouchableOpacity style={styles.dispatchButton} onPress={handleDispatchform}>
  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      <Text style={styles.tileHeader}>Licenses of Mining License Owner</Text>
      {/* Search Bar */}
