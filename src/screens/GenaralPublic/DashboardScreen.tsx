...
const GeneralPublicDashboard = () => {
  ...
  const handleCheck = () => {
    if (validateVehicleNumber(vehicleNumber)) {
      Alert.alert("Valid Vehicle", "The entered vehicle number is valid.");
    } else {
      Alert.alert("Invalid Vehicle", "The entered vehicle number is not valid.");
  ...
  return (
    <View style={styles.container}>
      ...
      General public users can verify a vehicles validity by entering its  vehicle number. The system checks the details against the database and  provides an instant result, confirming whether the vehicle is valid or  invalid. Additionally, users can submit complaints regarding suspicious  or unauthorized vehicles, ensuring better compliance and road safety.
      </Text>
      <TextInput 
        style={styles.input} 
